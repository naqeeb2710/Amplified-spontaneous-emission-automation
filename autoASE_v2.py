...
class App:
    ...
    def start_power_measurement(self):
        try:
            ...
            measurement_range = measurement_controller.PowerCalibaration()  # Initialize measurement range
            print('Defaultrng',measurement_controller.default_measurement_range)
